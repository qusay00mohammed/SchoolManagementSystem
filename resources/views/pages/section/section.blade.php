                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <form action="{{ route('section.update', [$ss->id]) }}" method="POST">
                                              ...
                                              <div class="col">
                                                <label class="control-label">{{ trans('trans_section.grade name') }}</label>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="col">
                    <label for="exampleFormControlSelect2" class="control-label">{{ trans('trans_section.grade name') }}</label>
